  ...
  var  cardNumber = $("#cardNumber").val();
   var expireOn  = $("#monthExpires").val() +"/"+  $("#yearExpires").val();
    ...
    if (cardNumber.length < 13 || cardNumber.length > 17) {
      $('#cardNumberErr').html("nhieu hon 13 ky tu va it hon 17");
      $('#cardNumber').css("border","1px solid red");
		    	return false;
    }
    if (!expireOn.match(/^(0[1-9]|10|11|12)[\/]20[0-9]{2}$/)) {
      $('#cardExpiresErr').html("ngay het han phai dung dinh dang");
      return false;
    }
    return true
  }
      ...
      <div class="modal-body">
        ...
        <form>
          ...
          <div class="form-group ">
            <label for="typeCard">Example select</label>
        ...
        <div id="messageErrorCredit" style="display: none; padding-top: 1em;">
          <div class="alert alert-warning alert-dismissible">
            <button type="button" class="close" data-dismiss="alert"
              ...
              <i class="icon fa fa-exclamation-triangle"></i>Tach nha

          </div>
        </div>
        <div class="sidebar-box ftco-animate fadeInUp ftco-animated ">
       <p style="color: black; font-size: large;">So du : <span style="color: blue;font-weight: bold;"> $ ${account.point}</span> </p>
          </div>
          <div class="sidebar-box ftco-animate fadeInUp ftco-animated ">
            <table class="table">
            ...
            <button type="button" id="btExampleModal" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" >Add Credit card</button>
                 </div>
