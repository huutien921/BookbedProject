    ...
    <div class="container">
        ...
        <div class="row block-9">
            ...
            <div class="col-md-6 order-md-last bg-white  d-flex mx-auto" style="border: 1px solid #d9dfe9;">
                ...
                <form:form method="POST" action="${pageContext.request.contextPath}/partner/createHotel" modelAttribute="hotel" enctype="multipart/form-data"
                    class="p-5 contact-form">
               ...
               <h5>Anh dai dien khach san</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="text-align: right;">
                                <button type="submit"
                                class="btn btn-primary">Tao khach san</button>
                            </div>
