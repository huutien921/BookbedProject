                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <form:form method="POST" action="${pageContext.request.contextPath}/roomManager/create" modelAttribute="room" enctype="multipart/form-data" class="p-5 contact-form" style="width: 100%;">
                                    ...
                                    <form:errors path="status"></form:errors>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div style="padding-bottom: 1em;">
                                                        <img style="width: auto; height: auto; max-width: 155px;min-width: 100px;min-height: 100px; " class="border border-primary" id="img-product">
                                                    </div>
