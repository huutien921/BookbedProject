...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/booking/**").access("hasRole('ROLE_SUPER_USER') or hasRole('ROLE_USER')")
				...
				.antMatchers("/partnerManager/**").access("hasRole('ROLE_SUPER_USER')")
				.antMatchers("/hotelManager/**").access("hasRole('ROLE_SUPER_USER')")
				.antMatchers("/roomManager/**").access("hasRole('ROLE_SUPER_USER')")
				.antMatchers("/partner/**").access("hasRole('ROLE_SUPER_USER') or hasRole('ROLE_USER')")
